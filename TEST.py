...
while (done):
    ...
    character = 700
    enemy = 350
    wizard = raw_input("what type of wizard would u like to be")
    mana = 0
    ...
    if spell== "flame spark" or spell== "ice shard" or spell== "life beam" or spell== "death blast" or spell== "myth blast" or spell== "lightning spark" or spell== "balance beam":
        if mana >= 0:
            ...
            print("You do not have enought mana and have fizzled")
        ...
        if mana >= 0:
            ...
            print("You do not have enough mana and have fizzled")
    elif spell== "fire cat": 
        enemy = enemy -120

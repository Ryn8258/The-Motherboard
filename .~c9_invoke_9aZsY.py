...
while (done):
    ...
    person = raw_input('Enter your name: ')
             print("You have died! Please restarfwt the game and try again")
    ...
    if wizard== "Fire" or wizard== "fire":
        ...
        print("You control Life and growth. Your spells deal little dadmage. You also have many spells to heal your teammates")
        ...
        print("You control Mythical creatures and energies. Your spells will hit most of the time and deal pretty good damage")
    ...
    print("A portal ripples in front of you and an elderly man steps -hrough. He introduces himself as Headmaster Ambrose of the Ravenwood Wizarding Academy")
    ...
    if spell== "flame spark" or spell== "ice shard" or spell== "life beam" or spell== "death blast" or spell== "myth blast" or spell== "lightning spark" or spell== "balance beam":
        ...
        print enemy
    print("Malistaire is starting his turn")
    print("Malistaire uses ghoul and deals 160 dam while healing for 80")
    ...
    if spell== "flame spark" or spell== "ice shard" or spell== "life beam" or spell== "death blast" or spell== "myth blast" or spell== "lightning spark" or spell== "balance beam":
        ...
        print enemy
    print("Malistaire is starting his turn")
    print("Malistaire uses dark pixie")

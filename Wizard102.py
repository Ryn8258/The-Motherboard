...
while (done2):
    ...
    character = 600
    if wizard== "Fire" or wizard== "fire":
        print("You have flame spark, fire in your spell deck")
    elif wizard== "Ice" or wizard== "ice":
        print("You have ice shard, and frost beetle in your spell deck")
    elif wizard== "Life" or wizard== "life":
        print("You have life beam, and imp in your spell deck")
...
while (done4):
    ...
    if enemy <= 0:
        print("You Win!")
        trophies = trophies + 1
        print("You now have " + trophies + "necklaces")
        done= False
        break
    else:
        time.sleep(3)
        print("The rotting fodder is starting it's turn")
        time.sleep(4)
        print("The rotting fodder uses ghoul and deals 160 dam and heals herself for 80 health")
        enemy = enemy + 80
        character = character - 160
        time.sleep(5)
        print("Enemy health =" + enemy)
        print("You healath =" + character)
        time.sleep(3)
        print("Your turn is starting")                                  #turn 4 battle 4
        time.sleep(2)
        if wizard== "Fire" or wizard== "fire":
            print("You have flame spark, fire cat, and fire elf in your spell deck")
        elif wizard== "Ice" or wizard== "ice":
        ...
        if enemy <= 0:
            print("You Win!")
            trophies = trophies + 1
            print("You now have " + trophies + "necklace")
            done= False
            break
        else:
            time.sleep(3)
            ...
            print character
            time.sleep(3)
            print("Your turn is starting")                                  #turn 5 battle 4
            time.sleep(2)
            if wizard== "Fire" or wizard== "fire":
                print("You have flame spark, fire cat, and fire elf in your spell deck")
            elif wizard== "Ice" or wizard== "ice":
            ...
            if enemy <= 0:
                ...
                print character
                time.sleep(3)
                print("Your turn is starting")                                                                                                  #turn 6 battle 4
                time.sleep(2)
                if wizard== "Fire" or wizard== "fire":
                    print("You have flame spark, fire cat, fire elf, and sun bird in your spell deck")
                elif wizard== "Ice" or wizard== "ice":
                ...
                if enemy <= 0:
                    ...
                    print("You healath =" + character)
                    time.sleep(3)
                    print("Your turn is starting")                                                                      #turn 7 battle 4
                    time.sleep(2)
                    if wizard== "Fire" or wizard== "fire":
                        print("You have flame spark, fire cat, fire elf, and sun bird in your spell deck")
                    elif wizard== "Ice" or wizard== "ice":
                    ...
                    if enemy <= 0:
                        ...
                        print character
                        time.sleep(3)
                        print("Your turn is starting")                                                                      #turn 8 battle 4
                        time.sleep(2)
                        if wizard== "Fire" or wizard== "fire":
                            print("You have flame spark, fire cat, fire elf, and sun bird in your spell deck")
                        elif wizard== "Ice" or wizard== "ice":
                        ...
                        if enemy <= 0:
                            ...
                            print("The rotting fodder it starting it's turn")
                            time.sleep(4)
                            print("The rotting fodder uses lightning spark and deals 60 dam")
                            character = character - 60
                            print("Your health =")
                            print character
                            time.sleep(3)
                            print("Your turn is starting")                                                                      #turn 9 battle 4
                            time.sleep(2)
                            if wizard== "Fire" or wizard== "fire":
                                print("You have flame spark, fire cat, fire elf, and sun bird in your spell deck")
                            elif wizard== "Ice" or wizard== "ice":
